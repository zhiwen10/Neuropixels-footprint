function wf = getWaveForms2(gwfparams)
...
for curUnitInd=1:numUnits
    ...
    for curSpikeTime = 1:min([gwfparams.nWf curUnitnSpikes])
        tmpWf = mmf.Data.x(1:gwfparams.nCh,round(spikeTimeKeeps(curUnitInd,curSpikeTime)*gwfparams.Fs+gwfparams.wfWin(1))...
            :round(spikeTimeKeeps(curUnitInd,curSpikeTime)*gwfparams.Fs+gwfparams.wfWin(end)));
